...
matrix_array <- array(c(first_matrix, second_matrix), dim = c(3, 3, 2))
...
4.  Print the second column of both matrices.
    ...
    ```{r}
value_5 <- matrix_array[2, 2, 1]
print(value_5)

third_row_first_matrix <- matrix_array[3, , 1]
print(third_row_first_matrix)


second_column_both_matrices <- matrix_array[, 2, ]
